...
export default function App(){
  ...
  var hSS=useCallback(async function(cl,ll,al,budgets,endDates,targetM,emails,customHols,onCallCons){var nd=Object.assign({},data,{consultants:cl,clients:ll,admins:al,clientBudgets:budgets,clientEndDates:endDates,targetMensile:targetM,consultantEmails:emails||{},customHolidays:customHols||[],onCallConsultants:onCallCons||[]});sData(nd);sSS(false);
    // Payload senza entries: hSS gestisce solo impostazioni, non entries.
    var p={consultants:cl,clients:ll,admins:al,clientBudgets:budgets,clientEndDates:endDates,targetMensile:targetM,consultantEmails:emails||{},customHolidays:customHols||[],onCallConsultants:onCallCons||[]};
