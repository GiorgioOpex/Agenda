...
const EMPTY = { consultants: [], clients: [], clientBudgets: {}, clientEndDates: {}, consultantEmails: {}, entries: {}, admins: [], targetMensile: 0 };
...
export async function POST(request) {
  try {
    ...
    if (body.consultantEmails !== undefined) db.consultantEmails = body.consultantEmails;
